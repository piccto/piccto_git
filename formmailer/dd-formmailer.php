...
$path_contact_page = 'unternehmen.html#kontakt';
...
$form_struct = '
	type=text|class=fmtext|label=Name|default=Ihr Name|fieldname=fm_name|max=100|req=true
	type=text|class=fmtext|label=E-Mail|default=Ihre E-Mail|fieldname=fm_email|max=100|req=true|ver=email
	type=textarea|class=fmtextarea|label=Nachricht|default=Ihre Nachricht|fieldname=fm_message|max=1000|rows=6|req=true
';
...
$sent_message = '<p>Vielen Dank.<br> Ihre Nachricht wurde erfolgreich abgesendet.</p>';
