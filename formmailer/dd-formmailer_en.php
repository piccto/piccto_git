...
$script_path = 'formmailer/dd-formmailer_en.php';
...
$path_contact_page = 'company.html#contact';
...
$recipients = 'info@mechatronic.de';
...
$form_struct = '
	type=text|class=fmtext|label=Name|default=Name|fieldname=fm_name|max=100|req=true
	type=text|class=fmtext|label=Phone|default=Phone|fieldname=fm_phone|max=100|req=true
	type=text|class=fmtext|label=Email|default=Email|fieldname=fm_email|max=100|req=true|ver=email
	type=textarea|class=fmtextarea|label=Message|default=Your Message|fieldname=fm_message|max=1000|rows=6|req=true
';
...
$email_subject = 'Mechatronic Kontakt';
...
$sent_message = '<p>Thank you.<br> Your message was successfully sent.</p>';
...
function ddfm_gen_text($item) {
	...
	$gen = "";
	$gen .= '<p class="fieldwrap"><label for="' . $item['fieldname'] . '">' . $req_text . $item['label'] . '</label>';
	$gen .= '<input class="' . $item['class'] . '" type="text" name="' . $item['fieldname'] . '" id="' . $item['fieldname'] . '" placeholder="';
